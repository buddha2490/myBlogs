...
I want to discuss three aspects of the SAS DATA step that form a mental model of data processing particular to SAS users and why this make it difficult for them to transition to modern open-source tools.
