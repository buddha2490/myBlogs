...
[GitHub Copilot](https://docs.posit.co/ide/user/ide/guide/tools/copilot.html) is an AI pair programmer than is integrated directly into your Rstudio IDE. It is a paid service that starts at \$10/month for individuals and \$19/user/month for teams. Once subscribed, users can activate the service within the global options many in Rstudio. Once activated, you can provide prompts to Copilot using the `#` comment character. After a brief pause, Copilot will provide a suggestion based on your prompt, which you can accept using the Tab key. When integrated into [Quarto](https://quarto.org) or [R Markdown](https://rmarkdown.rstudio.com) documents, Copilot will provide natural language support as well as code generation. GitHub Copilot is already a hit among developers and our team [has successfully used Copilot to build entire Shiny applications](https://www.procogia.com/link_to_mark).
